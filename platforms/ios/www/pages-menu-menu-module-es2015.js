...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                path: 'employees',
                loadChildren: () => __webpack_require__.e(/*! import() | employees-employees-module */ "employees-employees-module").then(__webpack_require__.bind(null, /*! ../employees/employees.module */ "./src/app/pages/employees/employees.module.ts")).then(m => m.EmployeesPageModule)
            },
        ]
    }
];
